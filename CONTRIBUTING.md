...
Welcome to `opensemantic.quantities` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.quantities`, please have a look
...
You can help improve `opensemantic.quantities` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.quantities` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.quantities`'s files. While this mechanism can
...
```
conda create -n opensemantic.quantities python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.quantities
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.quantities.git
   cd opensemantic.quantities
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.quantities` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.quantities
[issue tracker]: https://github.com/<USERNAME>/opensemantic.quantities/issues
